	...
	cards: [
		{
			...
			verb: 'nacer',
			hint: 'nacer — indefinido, 3ª pers. singular'
		},
		{
			...
			verb: 'trasladarse',
			hint: 'trasladarse — indefinido, 3ª pers. singular (verbo reflexivo)'
		},
		{
			...
			verb: 'estudiar',
			hint: 'estudiar — indefinido, 3ª pers. singular (-ar regular)'
		},
		{
			...
			verb: 'casarse',
			hint: 'casarse — indefinido, 3ª pers. singular (verbo reflexivo)'
		},
		{
			...
			verb: 'divorciarse',
			hint: 'divorciarse — indefinido, 3ª pers. plural (pron. reflexivo delante)'
		},
		{
			...
			verb: 'morir',
			hint: 'morir — indefinido, 3ª pers. singular (cambio o → u en la raíz)'
		},
		{
			...
			verb: 'tener',
			hint: 'tener — indefinido, 3ª pers. singular (irregular, raíz tuv-)'
		},
		{
			...
			verb: 'ganar',
			hint: 'ganar — indefinido, 3ª pers. singular (-ar regular)'
		},
		{
			...
			verb: 'recibir',
			hint: 'recibir — indefinido, 3ª pers. singular (-ir regular)'
		},
		{
			...
			verb: 'empezar',
			hint: 'empezar — indefinido, 3ª pers. singular (z → c en yo: empecé)'
		},
		{
			...
			verb: 'conocer',
			hint: 'conocer — indefinido, 3ª pers. singular (en indef. = "met", no "knew")'
		},
		{
			...
			verb: 'actuar',
			hint: 'actuar — indefinido, 3ª pers. singular (-ar regular, tilde en ó)'
		}
	]
};
